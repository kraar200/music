"""
        ...
        [InlineKeyboardButton("𝗞𝗜𝗠𝗢", callback_data="moslsl " + str(m.from_user.id))],
...
async def film(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝗞𝗜𝗠𝗢", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗜𝗠𝗢 ⌝⚡", url=f"https://t.me/D8_8Q")],
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝗞𝗜𝗠𝗢", callback_data="film " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗜𝗠𝗢 ⌝⚡", url=f"https://t.me/D8_8Q")],
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝗞𝗜𝗠𝗢", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗜𝗠𝗢 ⌝⚡", url=f"https://t.me/D8_8Q")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝗞𝗜𝗠𝗢", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗞𝗜𝗠𝗢 ⌝⚡", url=f"https://t.me/D8_8Q")],
